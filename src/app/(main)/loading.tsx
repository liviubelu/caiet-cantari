  ...
  return (
    <div className="bg-[#f0f2f5] dark:bg-gray-950 flex-1 animate-pulse">
      ...
      <div className="sticky top-0 z-40 bg-[#f0f2f5]/95 px-4 lg:px-8 pt-safe-header lg:pt-6 pb-3">
        ...
        <div className="h-7 w-48 bg-gray-300 dark:bg-gray-600 rounded mb-1.5" />
        <div className="h-3.5 w-20 bg-gray-200 dark:bg-gray-600 rounded mb-4" />
        {/* Search bar */}
      ...
      <div className="px-4 lg:px-8 py-2">
        {[3, 2, 2].map((count, gi) => (
          <div key={gi} className="mb-4">
            <div className="h-3 w-4 bg-gray-300 dark:bg-gray-600 rounded mb-2 mx-1" />
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2">
              {Array.from({ length: count }).map((_, i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl px-4 py-3.5 border border-gray-100 flex items-center gap-3">
